...
#' @title Data convert: generate KEGG ontology file for BiNGO (Cytoscape plugin)
#' @param out.file file name for output
...
#' @title Data convert: generate KEGG annotation file for BiNGO (Cytoscape plugin)
